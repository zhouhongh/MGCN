...
def main(opt,img_path):
    ...
    if opt.is_load:
        if dct_n == 20:
            model_path_len = 'checkpoint/h36m_short/ckpt_main_in10_out10_dctn20_best.pth.tar'
        else:
            model_path_len = 'checkpoint/h36m_long/ckpt_main_in10_out25_dctn35_best.pth.tar'
...
if __name__ == "__main__":
    ...
    main(option, "/mnt/DataDrive164/zhouhonghong/outputs/MGCN/h36m_long/imgs")
    save_gif("/mnt/DataDrive164/zhouhonghong/outputs/MGCN/h36m_long/imgs",
             "/mnt/DataDrive164/zhouhonghong/outputs/MGCN/h36m_long/gifs",)
